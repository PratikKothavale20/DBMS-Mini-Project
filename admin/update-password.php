...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($res==true)
        {
            ...
            if($count==1)
            {
                ...
                if($new_password==$confirm_password)
                {
                    ...
                    // check whether query query executed or not
                    if($res2==true)
                    {
                        // display success msg
                        // redirect to manage addmin page with success msg
                        ...
                        // display error msg
                        // redirect to manage addmin page with err msg
        ...
        // 3. chekc whether the new password and confirm password match or not
